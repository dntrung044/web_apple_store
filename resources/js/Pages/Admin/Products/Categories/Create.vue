<template>
    ...
    >
        <div class="mx-auto max-w-screen-xl px-1 lg:px-12 my-11 pb-11">
            ...
            <Breadcrump
                :links="{
                    'Danh sách danh mục': 'product_categories',
                    Tạo: '',
                }"
            ></Breadcrump>
                            ...
                            <div class="pr-5 border-r">
                                ...
                                <div class="grid gap-4">
                                    ...
                                    <FormSelect
                                        ...
                                        :name="'parent_id'"
                                        :select="'Danh mục cha'"
                                        :selected="categoryInfo.parent_id"
...
export default {
    ...
    methods: {
        ...
        createCategory() {
            ...
            this.form.post(`/dashboard/product_categories`, {
                preserveScroll: true,
            });
        },
    },
