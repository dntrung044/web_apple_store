    ...
    <footer class="border-t border-gray-line">
        ...
        <div class="container mx-auto px-4 py-10">
            <div class="flex flex-wrap -mx-4">
                ...
                <div class="w-full sm:w-1/6 px-4 mb-8">
                    ...
                    <ul>
                        <li>
                            <a href="/shop.html" class="hover:text-primary"
                                >Shop</a
                            >
                        </li>
                        <li>
                ...
                <div class="w-full sm:w-1/6 px-4 mb-8">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/checkout.html" class="hover:text-primary"
                                >Checkout</a
                            >
                        </li>
                        <li>
                            <a href="/404.html" class="hover:text-primary"
                                >404</a
                            >
                        </li>
                    </ul>
                ...
                <div class="w-full sm:w-1/6 px-4 mb-8">
                    ...
                    <ul>
                        <li>
                            <a href="/cart.html" class="hover:text-primary"
                                >Cart</a
                            >
                        </li>
                        <li>
                            <a href="/register.html" class="hover:text-primary"
                                >Registration</a
                            >
                        </li>
                        <li>
                ...
                <div class="w-full sm:w-2/6 px-4 mb-8">
                    ...
                    <a href="mailto:info@company.com" class="underline"
                        >Email: info@company.com</a
                    >
                </div>
            </div>
        </div>
        ...
        <div class="py-6 border-t border-gray-line">
            ...
            >
                <!-- Copyright and Links -->
                <div
                    class="w-full lg:w-3/4 text-center lg:text-left mb-4 lg:mb-0"
                >
                    <p class="mb-2 font-bold">
                        &copy; 2024 Your Company. All rights reserved.
                    </p>
                    <ul
                        class="flex justify-center lg:justify-start space-x-4 mb-4 lg:mb-0"
                    >
                        <li>
